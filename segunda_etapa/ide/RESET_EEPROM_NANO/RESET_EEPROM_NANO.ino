...
// ================================================
// Sube esto a SENDER_NANO (COM8) Y RECEIVER_UNO (COM3)
// Abre Serial Monitor a 115200 bps
// Cuando diga [OK], ya está listo
// Luego sube SENDER_NANO.ino o RECEIVER_UNO.ino normalmente
// ================================================
...
void setup() {
  ...
  if (nuevoBaudrate == 4800) {
    ...
    Serial.println(F("   2. Sube SENDER_NANO.ino (si es el Nano)"));
    Serial.println(F("   3. Sube RECEIVER_UNO.ino (si es el Uno)"));
    Serial.println(F("   4. Abre Serial Monitor a 4800 bps"));
    Serial.println(F("   5. Ejecuta: python src/servidor/main.py\n"));
  } else {
